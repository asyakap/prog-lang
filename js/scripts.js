window.onload = function () {
  ...
  form.addEventListener("submit", function (event) {
    ...
    } else if ((radioSelection2 === "iOS") && (name !== "") && (dob !== 0)) {
    ...
    } else if ((radioSelection2 === "android") && (name !== "") && (dob !== 0)) {
    ...
    } else if ((radioSelection2 === "data") && (name !== "") && (dob !== 0)) {
    ...
    } else if ((radioSelection2 === "cloud") && (name !== "") && (dob !== 0)) {
    ...
    if ((dob > "1993 - 01 - 01") && (name !== "") && (dob !== 0)) {
      result = result + " You have all the time in the world!";
    } else if ((dob < "1992 - 12 - 31") && (name !== "") && (dob !== 0)) {
